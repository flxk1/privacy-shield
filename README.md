...
opencv-python-headless>=4.8 (PDF, image; PyMuPDF is AGPL), `[credentials]`
cryptography>=42 (BYOK at rest), `[dev]` pyyaml>=6 + pytest>=7.
...
2.0.0 · 327 tests, 316 passing · Python >=3.10 · limits and gaps:
