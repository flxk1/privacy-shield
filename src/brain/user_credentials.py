...
Storage: brain/user/credentials/{username}.json (encrypted)
Master key: BRAIN_CREDENTIALS_MASTER_KEY env var or auto-generated
...
_DEFAULT_USER_ROOT = _ROOT / "brain" / "user"
...
def _master_secret_bytes() -> bytes:
    ...
    seed = (
        str(os.environ.get("BRAIN_CREDENTIALS_MASTER_KEY", "")).strip()
        or str(os.environ.get("BRAIN_SKILL_INTAKE_MASTER_KEY", "")).strip()
