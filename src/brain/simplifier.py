...
Usage:
    from brain.simplifier import simplify_response, should_simplify
...
def simplify_response_sync(
    ...
    try:
        from brain.services.llm_runtime import call_smart, LLMGatewayResult
...
async def simplify_response(
    ...
    try:
        from brain.services.llm_runtime import call_smart_async, LLMGatewayResult
    except ImportError as exc:
