...
Usage:
    from brain.llm_client import get_openai_client, get_anthropic_client
...
def _get_current_user() -> Optional[str]:
    ...
    try:
        ...
        user = brain_app.CURRENT_USER.get()
        role = brain_app.CURRENT_ROLE.get()
...
def _get_byok_key(
    ...
    """
    try:
        from brain.user_credentials import (
...
def get_local_client(
    ...
    if user_id:
        try:
            from brain.user_credentials import get_credential_for_provider
